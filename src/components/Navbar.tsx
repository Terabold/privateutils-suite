      ...
      <div className="container mx-auto max-w-[1400px] flex h-[72px] items-center justify-between px-4 lg:px-8 gap-4 md:gap-12">
           ...
           <div className="flex flex-wrap items-center gap-2 justify-center">
              <button
                ...
                className={`px-5 py-2 rounded-2xl font-black uppercase tracking-widest text-[10px] transition-all duration-300 flex items-center gap-2 border border-transparent ${
                  isHomePage && selectedCategory === null ? "bg-primary text-white shadow-lg shadow-primary/20 scale-105" : "text-muted-foreground hover:text-foreground hover:bg-primary/5"
                }`}
              >
        ...
        <div className="flex items-center gap-2 md:gap-4 shrink-0 md:min-w-[100px] justify-end">
          <Button 
            ...
            className="rounded-2xl hover:bg-primary/10 transition-colors h-10 w-10 border border-transparent hover:border-primary/10"
          >
