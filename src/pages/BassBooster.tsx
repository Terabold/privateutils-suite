...
import { ArrowLeft, RefreshCw, Download, Play, Pause, Music, Zap, CloudUpload, Speaker, Activity, RotateCcw } from "lucide-react";
...
const BassBooster = () => {
  ...
  const videoRef = useRef<HTMLVideoElement>(null); // Re-using videoRef name for consistency if needed, but audio uses audioRef
                    ...
                    <CardContent className="p-10">
                      ...
                      <div className="flex items-center justify-between">
                         <div className="flex items-center gap-3">
                            ...
                            <div>
                               <p className="text-[10px] font-black uppercase tracking-widest opacity-40 text-foreground">Spectral Weight</p>
