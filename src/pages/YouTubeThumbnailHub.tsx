          ...
          <div className="flex flex-col gap-10">
            <header className="flex items-center justify-between flex-wrap gap-6 animate-in fade-in slide-in-from-top-4 duration-500">
              ...
              <Button
                ...
                variant="outline"
                className="h-14 px-8 rounded-2xl border border-white/20 bg-background text-foreground font-black uppercase italic shadow-2xl gap-3 hover:bg-primary hover:text-white transition-all duration-300"
              >
            ...
            <div className="p-4 rounded-2xl bg-card border border-white/10 flex flex-wrap items-center gap-6 shadow-2xl animate-in fade-in slide-in-from-top-4 duration-500 inline-flex w-full">
              <div className="flex flex-col gap-1 flex-1 min-w-[300px]">
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-primary px-1 opacity-60 italic">Simulation Video Title</label>
              ...
              <div className="flex flex-col gap-1">
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-primary px-1 opacity-60 italic">Layout Mode</label>
              ...
              <div className="flex flex-col gap-1">
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-primary px-1 opacity-60 italic">Simulation Theme</label>
                <div className="flex bg-background/40 p-1 rounded-xl border border-white/10 h-11">
                  <button
              ...
              <div className="min-h-[500px] flex items-center justify-center animate-in fade-in zoom-in duration-300">
                ...
                >
                  ...
                  <div className="px-6 space-y-2">
                    ...
                    <p className="text-[10px] text-muted-foreground font-black uppercase tracking-[0.2em] opacity-40 italic">Drag thumbnail or click to browse</p>
                    <KbdShortcut />
                  </div>
                </Card>
              </div>
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="flex flex-wrap items-center justify-between gap-6">
                              ...
                              <div className="flex items-center gap-2">
                                <div className={`h-10 px-6 rounded-full border flex items-center justify-center gap-2 text-[10px] font-black uppercase tracking-widest ${ytTheme === 'dark' ? 'bg-white/10 border-white/10' : 'bg-zinc-100 border-zinc-200 text-zinc-600'}`}>
                                  <Check className="h-4 w-4" /> 254K
                                </div>
                                <div className={`h-10 px-8 rounded-full border flex items-center justify-center text-[10px] font-black uppercase tracking-widest ${ytTheme === 'dark' ? 'bg-white/10 border-white/10' : 'bg-zinc-100 border-zinc-200 text-zinc-600'}`}>Share</div>
                          ...
                          {[1, 2, 3, 4, 5, 6].map((i) => (
                            <div key={i} className={`flex gap-2 group cursor-pointer border-t py-3 first:border-0 first:pt-0 ${ytTheme === 'dark' ? 'border-white/5' : 'border-zinc-200'}`}>
                              <div className={`w-[168px] aspect-video rounded-2xl overflow-hidden shrink-0 relative border ${ytTheme === 'dark' ? 'bg-[#272727] border-white/5' : 'bg-zinc-100 border-zinc-200'}`}>
                                ...
                                />
                                <div className="absolute bottom-1 right-1 bg-black/80 text-[10px] font-black px-1 rounded-sm text-white">10:24</div>
                            ...
                            <div key={i} className={`flex flex-col sm:flex-row gap-6 group cursor-pointer transition-all duration-300 ${i === 1 ? 'order-first' : ''}`}>
                              ...
                              <div className="flex-1 py-1 space-y-2">
                                ...
                                <div className="flex gap-2 pt-1">
                                  <span className="text-[10px] bg-primary/10 px-2 py-0.5 rounded uppercase font-black tracking-widest text-primary border border-primary/20">Artifact</span>
                                  <span className={`text-[10px] px-2 py-0.5 rounded uppercase font-black tracking-widest border ${ytTheme === 'dark' ? 'bg-white/5 text-white/40 border-white/10' : 'bg-zinc-100 text-zinc-400 border-zinc-200'}`}>4K</span>
                                </div>
                              </div>
                            </div>
                          ))}
