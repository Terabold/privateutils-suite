                    ...
                    <div className="space-y-4">
                      ...
                      <DropdownMenu modal={false}>
                        <DropdownMenuTrigger asChild>
                          <Button
                            variant="outline"
                            className="w-full h-14 rounded-xl border-white/10 bg-background/40 font-black uppercase tracking-tighter italic flex items-center justify-between hover:bg-background/60 transition-all px-4"
                          >
                            <span className="truncate">{mode === "mono-to-stereo" ? "Mono ➔ Stereo" : "Stereo ➔ Mono"}</span>
                            <ChevronDown className="h-4 w-4 opacity-50" />
                          </Button>
                        </DropdownMenuTrigger>
                        <DropdownMenuContent className="rounded-xl border-primary/20 bg-background backdrop-blur-3xl min-w-[var(--radix-dropdown-menu-trigger-width)]">
                          <DropdownMenuItem
